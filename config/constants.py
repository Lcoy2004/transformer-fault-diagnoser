...
PD_FEATURES_DESC: Dict[str, str] = {
    'BAND1_ENERGY': '频带1能量', 'BAND2_ENERGY': '频带2能量',
    'BAND3_ENERGY': '频带3能量', 'BAND4_ENERGY': '频带4能量',
...
COLUMN_MAPPING: Dict[str, str] = {
    '故障类别': 'fault_type', '故障位置': 'fault_location', '故障类型': 'fault_type',
...
### Q7: 为什么需要数据降维？
**A**: PD数据维度较高（四通道×多特征），PCA降维可以提取主要特征，提高模型效率和准确率
